...
import { PageTitle, Table, EmptyRow, Loading } from "@/components/monitor-ui";
...
export default function DownloadNilai() {
  ...
  useEffect(() => {
    fetch("/api/monitor?bagian=nilai")
      .then((r) => r.json())
  ...
  return (
    <div className="mx-auto max-w-6xl">
      <PageTitle
        ...
        subtitle="Unduh rekap nilai siswa per mata pelajaran (khusus Kurikulum)."
      />
